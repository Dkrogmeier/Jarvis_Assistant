...
__all__ = [
    'DISPID_SASCurrentSeekPosition', 'DISPID_SPRsCount',
    'SAFTNonStandardFormat', 'DISPID_SVResume', 'SVEEndInputStream',
    'SVSFIsXML', 'SpeechRetainedAudioOptions', 'SECLowConfidence',
    'ISpRecoResult', 'DISPID_SRCEventInterests',
    'DISPID_SGRInitialState', 'ISpeechRecoResultTimes', 'SVP_15',
    'DISPID_SPPEngineConfidence', 'DISPID_SAFGuid',
    'eLEXTYPE_PRIVATE17', 'SPEI_UNDEFINED', 'SVSFNLPSpeakPunc',
    'STSF_CommonAppData', 'DISPID_SDKEnumKeys',
    ...
    'DISPID_SpeechLexiconPronunciation', 'SGRSTTWord',
    'DISPID_SVSInputSentenceLength', 'SVP_16', 'ISpResourceManager',
    'ISpeechPhraseReplacement', 'SPEI_ADAPTATION',
    'DISPID_SGRSTPropertyName', 'SAFTCCITT_uLaw_44kHzStereo',
    'SAFTADPCM_8kHzMono', 'SpUnCompressedLexicon',
    'SpeechAudioFormatGUIDText', 'eLEXTYPE_PRIVATE6',
    'SpPhraseInfoBuilder', 'SPEI_SOUND_START',
    'DISPID_SVGetAudioOutputs', 'eLEXTYPE_RESERVED7', 'SLTApp',
    'eLEXTYPE_PRIVATE9', 'SVP_1', 'DISPID_SASetState',
    'SAFTExtendedAudioFormat', 'DISPID_SVSInputWordPosition',
    'DISPID_SPEDisplayAttributes', 'SPSVerb', 'SP_VISEME_16',
    'SpObjectTokenCategory', 'DISPID_SRGRules', 'DISPID_SRRTimes',
    'DISPID_SLWs_NewEnum', 'SPEI_FALSE_RECOGNITION',
    'SPWORDPRONUNCIATIONLIST',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SAFT8kHz16BitStereo', 'SpeechDictationTopicSpelling',
    'DISPID_SOTMatchesAttributes', 'SAFT12kHz8BitMono',
    'DISPID_SOTCategory', 'SpeechGrammarTagUnlimitedDictation',
    'SPCT_SUB_DICTATION', 'SP_VISEME_2', 'ISpObjectTokenCategory',
    'SPSHT_NotOverriden', 'DISPID_SVSRunningState',
    'ISpeechPhraseElement', 'DISPID_SWFEAvgBytesPerSec',
    'SRSEIsSpeaking', 'DISPID_SVSyncronousSpeakTimeout',
    'SAFT16kHz16BitMono', 'SPEI_RESERVED2',
    'DISPID_SVSInputWordLength', 'DISPID_SRCEEndStream',
    'DISPID_SGRSAddSpecialTransition', '_RemotableHandle', 'SVP_6',
    'SPEI_SR_BOOKMARK', 'SPRULESTATE', 'SPEI_MIN_TTS',
    'DISPID_SPRuleConfidence', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'STSF_LocalAppData', 'SpeechBookmarkOptions',
    'SAFTCCITT_ALaw_22kHzStereo', 'SAFTCCITT_uLaw_44kHzMono',
    'SREAudioLevel', 'DISPID_SAEventHandle', 'DISPID_SPRulesItem',
    'SpeechTokenIdUserLexicon', 'SPPHRASEREPLACEMENT',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'DISPID_SPAsItem',
    'SAFTADPCM_44kHzStereo', 'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SPIEnginePrivateData', 'SVP_17', 'SPDKL_CurrentConfig',
    'SpCompressedLexicon', 'SPPS_RESERVED1',
    'DISPID_SpeechPhraseInfo', 'DISPID_SDKSetLongValue',
    'SPVPRIORITY', 'ISpeechTextSelectionInformation', 'SSTTDictation',
    'DISPID_SGRSTransitions', 'ISpLexicon',
    'DISPID_SGRSTPropertyValue', 'ISpeechVoiceStatus',
    'DISPID_SWFEFormatTag', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SGRClear', 'DISPID_SMSALineId',
    ...
    'SREStreamStart', 'SPBO_TIME_UNITS',
    'DISPID_SVSpeakCompleteEvent', 'DISPID_SLWPronunciations',
    'SP_VISEME_20', 'DISPID_SLWWord', 'SPPARTOFSPEECH',
    'ISpRecoGrammar', 'SpeechCategoryAudioOut',
    'ISpeechGrammarRuleStateTransition', 'eLEXTYPE_USER_SHORTCUT',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SGRsCommitAndSave',
    'SPAUDIOSTATUS', 'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SBOPause', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPBO_NONE',
    'DISPID_SGRSTText', 'DISPID_SpeechPhraseProperty',
    'DISPID_SVSkip', 'SRCS_Disabled', 'SAFTADPCM_11kHzStereo',
    'SREPhraseStart', 'DISPID_SOTs_NewEnum', 'SPEVENTENUM',
    'DISPID_SRCESoundStart', 'DISPID_SVDisplayUI',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SRCRequestedUIType',
    'SpeechTokenKeyFiles', 'SAFT22kHz8BitMono', 'DISPID_SGRsItem',
    'DISPID_SpeechObjectTokens', 'SREInterference', 'SP_VISEME_18',
    'ISpObjectWithToken', 'SPWT_PRONUNCIATION', 'SPEI_SOUND_END',
    'eLEXTYPE_PRIVATE7', 'SpeechTokenShellFolder',
    'SDKLCurrentConfig', 'SPPS_Noncontent',
    'SPINTERFERENCE_LATENCY_WARNING',
    'SpeechGrammarRuleStateTransitionType', 'SAFT32kHz16BitStereo',
    'DISPID_SRCState', 'DISPID_SVSCurrentStreamNumber',
    'DISPID_SPRuleEngineConfidence', 'DISPID_SPRuleChildren',
    'SDA_Two_Trailing_Spaces', 'SPXRO_Alternates_SML',
    'SPDKL_LocalMachine', 'eLEXTYPE_PRIVATE14',
    'DISPID_SRRTStreamTime', 'DISPID_SPERetainedStreamOffset',
    'SpeechPropertyResponseSpeed', 'SpeechStreamSeekPositionType',
    'SVSFDefault', 'ISpNotifySource', 'SGRSTTRule', 'SPSHT_Unknown',
    'ISpProperties', 'DISPID_SABIBufferSize',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'SPCS_DISABLED',
    'DISPID_SRSCurrentStreamPosition', 'SASRun', 'SPRST_NUM_STATES',
    'DISPID_SOTDataKey', 'SPVPRI_NORMAL', 'DISPID_SRProfile',
    'SAFT32kHz16BitMono', 'SAFTCCITT_uLaw_11kHzMono',
    'ISpeechResourceLoader', 'ISpeechCustomStream',
    'DISPID_SDKGetStringValue', 'DISPID_SASCurrentDevicePosition',
    'IStream', 'SPFM_CREATE_ALWAYS', 'DISPID_SGRAddState', 'SFTInput',
    'SpeechTokenKeyAttributes', 'DISPID_SRRAlternates',
    'SP_VISEME_11', 'SP_VISEME_21', 'SPSMF_SAPI_PROPERTIES',
    'SGRSTTTextBuffer', 'SRTEmulated', 'tagSPTEXTSELECTIONINFO',
    'DISPID_SAVolume', 'SPPS_Modifier', 'SPEI_WORD_BOUNDARY',
    'SRTStandard', 'SPBOOKMARKOPTIONS', 'DISPID_SDKCreateKey',
    'DISPID_SpeechRecoResult2', 'DISPID_SpeechPhraseElement',
    'DISPID_SPAsCount', 'ISpeechPhraseInfo', 'SAFT11kHz8BitStereo',
    'DISPID_SPIGetText', 'DISPID_SRCRetainedAudio',
    'DISPID_SpeechPhraseProperties', 'DISPID_SLWLangId',
    'DISPID_SRRRecoContext', 'SPGRAMMARWORDTYPE', 'SPCS_ENABLED',
    'SpeechLoadOption', 'DISPID_SOTId', 'DISPID_SRCEAudioLevel',
    'SPEI_SENTENCE_BOUNDARY', 'SASStop', 'DISPID_SPAPhraseInfo',
    'SpeechAllElements', 'SRAImport', 'ISpeechLexiconPronunciation',
    'SPEI_PHRASE_START', 'DISPID_SPRDisplayAttributes',
    'DISPID_SPRs_NewEnum', 'DISPID_SRCERequestUI',
    'SpeechRecognitionType', 'DISPID_SPPsCount', 'SPAR_Medium',
    'SVP_8', 'ISpRecoContext2', 'SVSFNLPMask',
    '__MIDL_IWinTypes_0009', 'DISPID_SPRuleNumberOfElements',
    'SPRS_INACTIVE', 'DISPID_SOTsCount', 'SVF_Emphasis',
    'SSTTTextBuffer', 'SAFT24kHz16BitStereo', 'SVSFPurgeBeforeSpeak',
    'DISPID_SRSClsidEngine', 'SpSharedRecoContext', 'SVP_14',
    'DISPID_SRGCommit', 'SAFT12kHz8BitStereo',
    'DISPID_SVEStreamStart', 'SRARoot', 'SpAudioFormat',
    'SECFIgnoreWidth', 'SpTextSelectionInformation',
    'SAFTTrueSpeech_8kHz1BitMono', 'SPLO_DYNAMIC',
    'SWPUnknownWordPronounceable', 'STCInprocHandler',
    'DISPID_SRCEHypothesis', 'Speech_StreamPos_RealTime',
    'DISPID_SPRuleParent', 'DISPID_SRSetPropertyString',
    'DISPID_SLPSymbolic', 'DISPID_SPIAudioStreamPosition',
    'ISpeechPhraseProperties', 'DISPID_SPIReplacements', 'SASPause',
    'SPEVENT', 'SpInProcRecoContext', 'SPPS_RESERVED2', 'SPVPRI_OVER',
    'DISPID_SRCSetAdaptationData', 'DISPID_SOTRemove',
    'SPSHORTCUTTYPE', 'DISPID_SGRsCommit',
    'DISPID_SLGetGenerationChange', 'SPBINARYGRAMMAR', 'SP_VISEME_19',
    '_ISpeechVoiceEvents', 'SGLexical', 'SPSEMANTICFORMAT',
    'SPAS_RUN', 'SVP_5', 'DISPID_SVWaitUntilDone', 'SPAR_High',
    'SPWORDLIST', 'DISPID_SRCCreateResultFromMemory',
    'DISPID_SRCEStartStream', 'SPPS_Unknown', 'SSSPTRelativeToEnd',
    'SPSTREAMFORMATTYPE', 'SDTAlternates',
    'DISPID_SpeechAudioBufferInfo', 'SAFTCCITT_uLaw_11kHzStereo',
    'SVF_None', 'SP_VISEME_1', 'DISPID_SpeechCustomStream',
    'DISPID_SDKSetBinaryValue', 'SGRSTTDictation',
    'DISPID_SGRSAddWordTransition', 'SRERequestUI',
    'SPSHORTCUTPAIRLIST', 'SGDisplay', 'eLEXTYPE_LETTERTOSOUND',
    'DISPID_SWFEExtraData', 'SpeechRecoEvents', 'ISpNotifyTranslator',
    'DISPID_SPRText', 'DISPID_SRStatus', 'SWPKnownWordPronounceable',
    'DISPID_SDKOpenKey', 'SREHypothesis', 'ISpeechLexiconWord',
    'SECFDefault', 'SAFT48kHz8BitStereo', 'ISpObjectToken',
    'SpMemoryStream', 'ISpeechPhraseAlternates', 'SP_VISEME_13',
    'ISpeechPhraseElements', 'SPEI_START_INPUT_STREAM',
    'DISPID_SPPsItem', 'DISPID_SRRecognizer',
    'DISPID_SWFESamplesPerSec', 'SITooFast', 'SPEI_RESERVED3',
    'DISPID_SpeechRecoResult', 'SPAS_STOP', 'SRERecognition',
    'SP_VISEME_12', 'SPCT_COMMAND', 'DISPID_SOTIsUISupported',
    'SAFT16kHz8BitStereo', 'ISpeechMemoryStream', 'SPDKL_CurrentUser',
    'SVPNormal', 'DISPID_SVEPhoneme', 'ISpStream',
    'SPPS_NotOverriden', 'SAFT32kHz8BitMono', 'DISPID_SVSLastResult',
    'SVP_19', 'DISPIDSPTSI_ActiveOffset', 'DISPID_SPELexicalForm',
    'eLEXTYPE_RESERVED4', 'DISPID_SPEEngineConfidence',
    'SPPHRASEPROPERTY', 'eLEXTYPE_PRIVATE13', 'SpeechTokenContext',
    'eLEXTYPE_APP', 'SPINTERFERENCE_NOSIGNAL', 'DISPID_SpeechVoice',
    'DISPID_SPCPhoneToId', 'SVSFParseMask',
    'ISpStreamFormatConverter', 'ISpGrammarBuilder',
    'SPWORDPRONUNCIATION', 'DISPID_SMSADeviceId',
    'DISPID_SRSetPropertyNumber', 'SRAONone', 'DISPID_SRRAudio',
    'SRAExport', 'SpeechAudioVolume', 'SPRECOGNIZERSTATUS',
    'DISPID_SpeechAudioStatus', 'SAFT24kHz8BitMono',
    'SVEStartInputStream', 'SAFT44kHz8BitStereo', 'SpPhoneConverter',
    'SpWaveFormatEx', 'SRSInactive', 'SECNormalConfidence',
    'SPGRAMMARSTATE', 'SpeechVoicePriority', 'DISPID_SOTSetId',
    'SVSFlagsAsync', 'SAFT32kHz8BitStereo', 'ISpeechAudioBufferInfo',
    'SPINTERFERENCE_NONE', 'SPRST_INACTIVE', 'SPAUDIOOPTIONS',
    'DISPID_SADefaultFormat', 'ISpRecoGrammar2',
    'DISPID_SpeechGrammarRuleState', 'SPWORDPRONOUNCEABLE',
    'ISpeechAudio', 'DISPID_SVGetProfiles', 'DISPID_SVEEnginePrivate',
    'DISPID_SRSSupportedLanguages', 'Speech_Max_Pron_Length',
    'DISPID_SOTDisplayUI', 'SPINTERFERENCE_TOOQUIET', 'SPEI_MAX_TTS',
    'tagSTATSTG', 'ISpPhoneConverter', 'SpVoice', 'ISpEventSink',
    'DISPID_SRGReset', 'DISPID_SVEBookmark', 'DISPID_SABIEventBias',
    'SPLEXICONTYPE', 'SpeechDataKeyLocation', 'SDA_No_Trailing_Space',
    'SpeechPropertyNormalConfidenceThreshold',
    'DISPID_SPERequiredConfidence', 'ISpNotifySink',
    'DISPID_SpeechVoiceStatus', 'SLTUser', 'DISPID_SPRulesCount',
    'WAVEFORMATEX', 'SDTProperty', 'SPBO_AHEAD', 'SPSNotOverriden',
    'SVSFPersistXML', 'SPRS_ACTIVE_USER_DELIMITED',
    'SAFT24kHz8BitStereo', 'DISPID_SPRules_NewEnum',
    'DISPID_SRCEEnginePrivate', 'DISPID_SpeechWaveFormatEx',
    'DISPID_SPIRetainedSizeBytes', 'ISpStreamFormat',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SRGRecoContext',
    'SPFM_NUM_MODES', 'DISPID_SPIStartTime',
    'SpeechWordPronounceable', 'SPWORD', 'DISPID_SVEAudioLevel',
    'SPPS_SuppressWord', 'SP_VISEME_3', 'SP_VISEME_14',
    'SpeechCategoryAppLexicons', 'DISPID_SRGCmdSetRuleState',
    'DISPID_SBSSeek', 'SPEI_MIN_SR', 'SpInprocRecognizer',
    'DISPID_SGRName', 'SRTAutopause', 'DISPID_SRCPause',
    'SPRECOCONTEXTSTATUS', 'SpeechCategoryVoices',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001', 'SP_VISEME_15',
    'ISpeechAudioFormat', 'SVEAudioLevel', 'DISPID_SLGenerationId',
    'SPPS_Noun', 'DISPID_SPPParent', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SRGetPropertyString', 'SAFTADPCM_22kHzMono',
    'ISpeechGrammarRuleState', 'SAFTADPCM_22kHzStereo',
    'DISPID_SPEAudioSizeTime', 'SDTAll', 'DISPID_SPRFirstElement',
    'SpeechAudioProperties', 'ISpVoice',
    'DISPID_SOTGetStorageFileName', 'SVPAlert',
    'SpStreamFormatConverter', 'ISpeechPhraseRules',
    'DISPID_SASFreeBufferSpace', 'SPWT_DISPLAY', 'SpeechFormatType',
    'SDTAudio', 'eLEXTYPE_USER',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPEI_TTS_AUDIO_LEVEL',
    'SRATopLevel', 'SPCT_DICTATION', 'eLEXTYPE_RESERVED9',
    'DISPID_SLWType', 'eLEXTYPE_PRIVATE4', 'DISPID_SPIProperties',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'ISpPhrase',
    'DISPID_SpeechRecognizer', 'ISpeechXMLRecoResult',
    'eLEXTYPE_PRIVATE3', 'SpeechRecoProfileProperties', 'SITooQuiet',
    'SWTDeleted', 'DISPID_SAFGetWaveFormatEx', 'SpResourceManager',
    'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SpeechPropertyComplexResponseSpeed',
    'DISPID_SpeechObjectTokenCategory', 'ISpRecoCategory',
    'DISPID_SpeechVoiceEvent', 'DISPID_SPPConfidence',
    'ISpeechLexicon', 'SPEI_RECOGNITION', 'eLEXTYPE_RESERVED10',
    'SVEAllEvents', '_SPAUDIOSTATE', 'DISPID_SASNonBlockingIO',
    'DISPID_SpeechLexiconWord', 'DISPID_SRGCmdSetRuleIdState',
    'SpeechPropertyAdaptationOn', 'ISpEventSource', 'SP_VISEME_8',
    'DISPID_SPCLangId', 'SPGS_DISABLED', 'STCRemoteServer',
    'SDKLDefaultLocation', 'DISPID_SREmulateRecognition',
    'SpShortcut', 'SPRS_ACTIVE', 'SpeechInterference',
    'DISPID_SPIAudioSizeTime', 'SVP_7', 'SVP_10', 'DISPID_SLWsItem',
    'DISPID_SVPause', 'DISPID_SPEDisplayText', 'SRESoundStart',
    'SPSNoun', 'DISPID_SDKGetBinaryValue', 'ISpeechPhoneConverter',
    'SINoSignal', 'DISPID_SGRSTRule', 'SREPrivate',
    'SAFT8kHz8BitStereo', 'DISPID_SLPPartOfSpeech', 'SPSInterjection',
    'DISPID_SVSVisemeId', 'SPEI_PHONEME', 'SPEI_RESERVED5',
    'DISPID_SpeechGrammarRules', 'SINoise', 'SPEI_RECO_STATE_CHANGE',
    'DISPID_SRRTOffsetFromStart', 'ISpeechMMSysAudio',
    'DISPID_SPRuleFirstElement', 'DISPID_SLPPhoneIds',
    'eWORDTYPE_ADDED', 'eLEXTYPE_PRIVATE1', 'SPAUDIOBUFFERINFO',
    'SpeechDisplayAttributes', 'DISPIDSPTSI_ActiveLength', 'SBONone',
    'DISPID_SGRId', 'eLEXTYPE_PRIVATE10', 'DISPID_SBSRead',
    'DISPID_SRRSaveToMemory', 'ISpeechBaseStream',
    'SREPropertyNumChange', 'SVP_11', 'DISPID_SLGetWords',
    'DISPID_SPEsItem', 'SPAO_NONE', 'SAFTCCITT_ALaw_44kHzMono',
    'SPFM_OPEN_READONLY', 'SREStateChange', 'ISpeechFileStream',
    'SpeechVoiceSkipTypeSentence', 'SSFMOpenReadWrite', 'SASClosed',
    'DISPID_SRSCurrentStreamNumber', 'SAFT16kHz8BitMono',
    'DISPID_SpeechGrammarRuleStateTransition', 'SPINTERFERENCE',
    'DISPID_SGRSTWeight', 'SRTSMLTimeout',
    'DISPID_SpeechPhraseAlternates', 'DISPID_SOTGetAttribute',
    'eLEXTYPE_RESERVED8', 'SREAllEvents', 'SPSModifier',
    'DISPID_SVGetAudioInputs', 'SPDKL_DefaultLocation',
    'SPSHORTCUTPAIR', 'SREStreamEnd', 'DISPID_SpeechPhraseElements',
    'DISPID_SpeechLexicon', 'SVSFIsNotXML', 'ISpeechDataKey',
    'IInternetSecurityManager', 'SECFIgnoreKanaType',
    'DISPID_SDKSetStringValue', 'SpeechGrammarWordType',
    'SPEI_END_SR_STREAM', 'SDKLCurrentUser', 'DISPID_SLPsItem',
    'DISPID_SRRSetTextFeedback', 'SPWAVEFORMATTYPE',
    'DISPID_SDKDeleteKey', 'DISPID_SRGState', 'SPEI_SR_PRIVATE',
    'DISPID_SOTCEnumerateTokens', 'SAFTDefault', 'ISpeechRecoGrammar',
    'DISPID_SAStatus', 'SpeechAddRemoveWord',
    'SAFTCCITT_uLaw_22kHzMono', 'SAFTGSM610_11kHzMono',
    'eLEXTYPE_RESERVED6', 'DISPID_SLPType', 'SPINTERFERENCE_TOOLOUD',
    'DISPID_SLGetPronunciations', 'SPSMF_UPS',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SGRs_NewEnum',
    'DISPID_SFSOpen', 'SP_VISEME_5', 'SGRSTTWildcard',
    'SECHighConfidence', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SpeechPhoneConverter', 'SAFT12kHz16BitMono',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SRRAudioFormat',
    'SpeechPropertyResourceUsage', 'SGDSActive', 'SPAR_Low',
    'SPAS_PAUSE', 'SpeechEngineConfidence',
    ...
    'DISPID_SRGSetTextSelection', 'SVEVoiceChange', 'SREBookmark',
    'DISPID_SVAlertBoundary', 'SVEPhoneme', 'DISPID_SMSSetData',
    'SAFT16kHz16BitStereo', 'SRERecoOtherContext',
    'DISPID_SRGCmdLoadFromMemory', 'SINone', 'DISPID_SABufferInfo',
    'SAFT22kHz16BitStereo', 'SAFTGSM610_8kHzMono', 'SGSEnabled',
    'DISPID_SVIsUISupported', 'DISPID_SpeechAudioFormat',
    'SpPhoneticAlphabetConverter', 'SPEI_RESERVED6', 'SPPS_Function',
    'DISPID_SOTRemoveStorageFileName', 'DISPID_SRRDiscardResultInfo',
    'DISPID_SRCEAdaptation', 'DISPID_SpeechDataKey',
    'DISPID_SGRAttributes', 'SPPS_RESERVED4', 'SPEI_TTS_BOOKMARK',
    'STSF_FlagCreate', 'ISpRecoContext',
    'DISPID_SpeechPhraseReplacements', 'SDKLLocalMachine',
    'DISPID_SRGetFormat', 'DISPID_SPRuleId', 'SPEI_INTERFERENCE',
    'SAFT11kHz16BitStereo', 'SpMMAudioOut',
    'DISPID_SLRemovePronunciation', 'SPPS_RESERVED3', 'SGSExclusive',
    'DISPIDSPTSI_SelectionLength', 'SPAR_Unknown', 'DISPID_SLWsCount',
    'DISPID_SPEAudioSizeBytes', 'ISpeechPhraseInfoBuilder',
    'DISPID_SRRGetXMLErrorInfo', 'ISpRecognizer3', 'DISPID_SOTCSetId',
    'eLEXTYPE_PRIVATE12', 'SpeechCategoryAudioIn',
    'DISPID_SPIEngineId', 'DISPID_SVEventInterests', 'SVP_4',
    'SpeechCategoryPhoneConverters', 'SPVPRI_ALERT',
    'SREFalseRecognition', 'DISPID_SPAs_NewEnum',
    'DISPID_SpeechBaseStream', 'SPFM_OPEN_READWRITE', 'SP_VISEME_17',
    'SDTDisplayText', 'DISPID_SVPriority', 'SPDATAKEYLOCATION',
    'SAFTADPCM_11kHzMono', 'SPINTERFERENCE_TOOFAST',
    'ISpSerializeState', 'SpeechTokenValueCLSID', 'SVSFParseSsml',
    'DISPID_SRIsShared', 'SPEI_RESERVED1', 'DISPID_SpeechObjectToken',
    'SAFT48kHz16BitStereo', 'SpMMAudioEnum', 'DISPID_SPISaveToMemory',
    'SPEI_PROPERTY_NUM_CHANGE', 'DISPID_SWFEChannels',
    'SPWF_SRENGINE', 'ISpeechRecoResultDispatch',
    'SpeechPropertyLowConfidenceThreshold', 'SVSFVoiceMask',
    'SpeechUserTraining', 'SPVOICESTATUS', 'eLEXTYPE_PRIVATE16',
    'DISPID_SWFEBitsPerSample', 'STSF_AppData', 'SECFIgnoreCase',
    'DISPID_SRCEPropertyNumberChange', 'SVP_21', 'DISPID_SMSGetData',
    'DISPID_SpeechFileStream', 'SAFTADPCM_44kHzMono', 'SVEViseme',
    'SpeechRecoContextState', 'LONG_PTR',
    'SpeechCategoryRecoProfiles', 'SDA_One_Trailing_Space',
    'DISPID_SpeechRecoResultTimes', 'SAFT11kHz8BitMono',
    'SpCustomStream', 'SPSFunction', 'ISpeechRecoResult2',
    'eLEXTYPE_MORPHOLOGY', 'SPSHT_EMAIL', 'SpeechMicTraining',
    'ISpeechObjectToken', 'SVP_18', 'DISPID_SRGDictationLoad',
    'DISPID_SVRate', 'SpeechTokenKeyUI', 'SAFT8kHz16BitMono',
    'ISpRecognizer', 'tagSPPROPERTYINFO', 'DISPID_SVEVoiceChange',
    'SpeechRunState', 'DISPID_SPPValue', 'SPSMF_SRGS_SAPIPROPERTIES',
    'SVP_9', 'SpStream', 'eLEXTYPE_PRIVATE5', 'Speech_Default_Weight',
    'SPPS_Verb', 'SRTReSent', 'SpeechRecognizerState',
    'DISPID_SVEWord', 'DISPID_SGRsCount', 'SpeechLexiconType',
    'DISPID_SVSLastBookmark', 'DISPID_SVESentenceBoundary',
    'DISPID_SVSpeak', 'IEnumString', 'eLEXTYPE_VENDORLEXICON',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SVStatus',
    'SPAUDIOSTATE', 'ISpeechAudioStatus',
    'DISPID_SRCERecognizerStateChange', 'SpeechWordType',
    'DISPID_SVVolume', 'DISPID_SRCCmdMaxAlternates',
    'eLEXTYPE_PRIVATE18', 'SRSInactiveWithPurge', 'SpeechDiscardType',
    'DISPID_SRGId', 'DISPID_SASState', 'DISPID_SRCEBookmark',
    'SPEI_SR_RETAINEDAUDIO', 'ISpeechLexiconPronunciations',
    'SpeechVisemeFeature', 'DISPID_SVEViseme', 'SpeechGrammarState',
    'DISPID_SDKGetlongValue', 'IInternetSecurityMgrSite',
    'DISPID_SPERetainedSizeBytes', 'SPGS_EXCLUSIVE',
    'DISPID_SABufferNotifySize', 'SpeechVoiceCategoryTTSRate',
    'SPGS_ENABLED', 'SREAdaptation', 'ISpeechPhraseProperty',
    'DISPID_SABIMinNotification', 'DISPID_SRAudioInputStream',
    'DISPID_SAFType', 'DISPID_SRCVoice', 'DISPID_SRCBookmark',
    'DISPID_SPEAudioTimeOffset', 'ISpeechVoice', 'SVF_Stressed',
    'ISpeechWaveFormatEx', 'DISPID_SPRsItem', 'DISPID_SGRAddResource',
    'SRADefaultToActive', 'SP_VISEME_4', 'SpeechGrammarTagDictation',
    'DISPID_SPEs_NewEnum', 'SGPronounciation',
    'DISPID_SpeechPhraseRule', 'DISPID_SGRSTsCount', 'SVP_0',
    'DISPID_SCSBaseStream', 'DISPID_SVVoice', 'SVP_13',
    'SVESentenceBoundary', 'DISPID_SRCEFalseRecognition',
    'DISPID_SRCreateRecoContext', 'SAFTGSM610_22kHzMono',
    'ISpXMLRecoResult', 'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN',
    'SGSDisabled', 'SPSEMANTICERRORINFO', 'DISPID_SRGDictationUnload',
    'SpMMAudioIn', 'SAFTCCITT_ALaw_44kHzStereo', 'SPSLMA',
    'SGRSTTEpsilon', 'SPCT_SLEEP', 'DISPID_SpeechRecoContextEvents',
    'DISPID_SLPs_NewEnum', 'DISPID_SPPNumberOfElements',
    'DISPID_SRCVoicePurgeEvent', 'SVSFIsFilename',
    'SPEI_RECO_OTHER_CONTEXT', 'DISPID_SLPsCount', 'STCInprocServer',
    'DISPID_SPIRule', 'STCLocalServer', 'DISPID_SBSFormat',
    'SP_VISEME_9', 'SGLexicalNoSpecialChars', 'eLEXTYPE_PRIVATE20',
    'SPCT_SUB_COMMAND', 'DISPID_SLAddPronunciation',
    'DISPID_SOTCreateInstance', 'DISPID_SVSpeakStream', 'SPSHT_OTHER',
    'SVPOver', 'ISequentialStream', 'SP_VISEME_6', 'ISpMMSysAudio',
    'SRESoundEnd', '_ISpeechRecoContextEvents',
    'DISPID_SpeechLexiconProns', 'SPFM_CREATE', 'SVP_12',
    'DISPID_SRGetPropertyNumber', 'eLEXTYPE_PRIVATE19',
    'DISPID_SPILanguageId', 'DISPID_SpeechRecognizerStatus',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPAS_CLOSED',
    'SAFTADPCM_8kHzStereo', 'SRADynamic',
    'DISPID_SRGSetWordSequenceData', 'SPEI_MAX_SR',
    'DISPID_SOTCDefault', 'SAFT22kHz16BitMono',
    'SpeechAudioFormatGUIDWave', 'SAFTCCITT_ALaw_22kHzMono',
    'DISPID_SOTsItem', 'DISPID_SGRSTPropertyId', 'SLOStatic',
    'SP_VISEME_0', 'eLEXTYPE_PRIVATE2', 'DISPID_SRSAudioStatus',
    'SDTLexicalForm', 'SPEI_START_SR_STREAM', 'SpSharedRecognizer',
    'SpeechVoiceSpeakFlags', 'SpLexicon', 'SECFEmulateResult',
    'SpFileStream', 'SAFTGSM610_44kHzMono', 'SPBO_PAUSE',
    'DISPID_SRCAudioInInterferenceStatus', 'DISPID_SRCEInterference',
    'DISPID_SOTCGetDataKey', 'SpeechVisemeType',
    'SPADAPTATIONRELEVANCE', 'DISPID_SFSClose',
    'SAFTCCITT_ALaw_11kHzMono', 'SRAInterpreter',
    'DISPID_SVSInputSentencePosition',
    'DISPID_SPAStartElementInResult', 'SPXMLRESULTOPTIONS',
    'SAFT44kHz8BitMono', 'SpeechAudioState',
    'SGDSActiveWithAutoPause', 'SVEWordBoundary',
    'ISpeechRecoContext', 'DISPID_SRGCmdLoadFromFile',
    'SWPUnknownWordUnpronounceable', 'SVSFParseAutodetect',
    'Speech_StreamPos_Asap', 'DISPID_SRGIsPronounceable',
    'DISPID_SPARecoResult', 'ISpPhoneticAlphabetConverter',
    'DISPID_SpeechAudio', 'ISpDataKey', 'SFTSREngine',
    'ISpeechRecognizerStatus', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SRCERecognition', 'SSFMCreate', 'SPPS_Interjection',
    'ISpeechRecognizer', 'SpeechSpecialTransitionType',
    'SAFT12kHz16BitStereo', 'SPEI_SR_AUDIO_LEVEL', 'DISPID_SGRsAdd',
    'DISPID_SpeechMemoryStream', 'SVP_3', 'SAFTText',
    'DISPID_SVSPhonemeId', 'DISPID_SGRsDynamic', 'SPWT_LEXICAL',
    'DISPIDSPTSI', 'DISPID_SRCEPropertyStringChange',
    'ISpeechObjectTokens', 'SAFT44kHz16BitMono', 'DISPID_SPIElements',
    'SpNullPhoneConverter', 'DISPID_SVSLastStreamNumberQueued',
    'SPEI_VOICE_CHANGE', 'SpObjectToken',
    'DISPID_SVAudioOutputStream', 'SPPHRASE', 'DISPID_SGRSTType',
    'SVSFParseSapi', 'DISPID_SPEAudioStreamOffset', 'SSFMOpenForRead',
    'DISPID_SpeechPhraseRules', 'SRSActive', 'SPLO_STATIC',
    'DISPID_SRRSpeakAudio', 'DISPID_SVEStreamEnd',
    'SAFTCCITT_uLaw_8kHzMono', 'DISPID_SGRSTNextState',
    'SAFT48kHz8BitMono', 'SGDSActiveUserDelimited',
    'eLEXTYPE_PRIVATE15', 'DISPID_SRCERecognitionForOtherContext',
    'SAFT44kHz16BitStereo', 'DISPID_SRCResume',
    'SAFTCCITT_ALaw_8kHzMono', 'SVEBookmark', 'SSTTWildcard',
    'SRTExtendableParse', 'ISpeechGrammarRules',
    'DISPID_SpeechPhraseAlternate', 'SPRULE',
    'SREPropertyStringChange', 'DISPID_SGRsFindRule',
    'DISPID_SRIsUISupported', 'DISPID_SRCEPhraseStart',
    'DISPID_SPRuleName', 'SPEI_END_INPUT_STREAM', 'SRSEDone',
    'SPEI_REQUEST_UI', 'DISPID_SVGetVoices',
    'DISPID_SGRSAddRuleTransition', 'SAFT8kHz8BitMono', 'SITooLoud',
    'ISpeechLexiconWords', 'SPSSuppressWord', 'SRSActiveAlways',
    'SPEI_HYPOTHESIS', 'DISPID_SPEPronunciation', 'SVP_20',
    'SPWORDTYPE', 'Speech_Max_Word_Length', 'STCAll',
    'DISPID_SMSAMMHandle', 'SITooSlow', 'DISPID_SGRSTsItem',
    'DISPID_SOTCId', 'DISPID_SPEsCount',
    'DISPID_SLAddPronunciationByPhoneIds', 'DISPID_SRState',
    'DISPID_SRCRecognizer', 'SPCONTEXTSTATE',
    'DISPID_SpeechPhraseReplacement', 'SDA_Consume_Leading_Spaces',
    'DISPID_SpeechMMSysAudio', 'SPPROPERTYINFO',
    'DISPID_SDKEnumValues', 'SRCS_Enabled', 'DISPID_SRGetRecognizers',
    'DISPID_SPPName', 'DISPID_SPPFirstElement',
    'SpeechRegistryLocalMachineRoot', 'SVSFUnusedFlags',
    'SPINTERFERENCE_TOOSLOW', 'DISPID_SWFEBlockAlign',
    'SpeechStreamFileMode', 'DISPID_SPIAudioSizeBytes', 'SPRECOSTATE',
    'DISPID_SDKDeleteValue', 'SpeechEngineProperties',
    'DISPID_SRRTTickCount', 'ISpPhraseAlt', 'SPRST_ACTIVE',
    'DISPID_SRRTLength', 'SWTAdded', 'SAFT11kHz16BitMono',
    'SLODynamic', 'SP_VISEME_10', 'SPRECORESULTTIMES', 'DISPID_SPPId',
    'DISPID_SBSWrite', 'DISPID_SRAudioInput',
    'DISPID_SpeechLexiconWords', 'SPTEXTSELECTIONINFO',
    'ISpeechGrammarRule', 'SPEVENTSOURCEINFO', 'SGDSInactive',
    'SpeechRuleState', 'SDTPronunciation', 'SSFMCreateForWrite',
    'UINT_PTR', 'DISPID_SGRSRule', 'eLEXTYPE_PRIVATE11',
    'IEnumSpObjectTokens', 'DISPID_SpeechXMLRecoResult',
    ...
    'DISPID_SPCIdToPhone', 'SPEI_VISEME', 'SPCATEGORYTYPE',
    'SAFTCCITT_ALaw_11kHzStereo', 'SECFNoSpecialChars', 'SDTRule',
    'SPPHRASERULE', 'DISPID_SLRemovePronunciationByPhoneIds',
    'SpNotifyTranslator', 'SRAORetainAudio', 'SpeechRegistryUserRoot',
    'DISPIDSPTSI_SelectionOffset', 'SPAO_RETAIN_AUDIO',
    'SpeechRuleAttributes', 'SPPS_LMA',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPSUnknown',
    'DISPID_SVAudioOutput', 'DISPID_SpeechRecoContext', 'SPWF_INPUT',
    'SpeechGrammarTagWildcard', 'DISPID_SOTGetDescription',
    'SpeechCategoryRecognizers', 'DISPID_SAFSetWaveFormatEx',
    'SPPHRASEELEMENT', 'SVP_2', 'SPFILEMODE', 'SAFT48kHz16BitMono',
    'ISpShortcut', 'DISPID_SRCESoundEnd', 'eWORDTYPE_DELETED',
    'SAFT24kHz16BitMono', 'ISpeechPhraseRule', 'SPINTERFERENCE_NOISE',
    'DISPID_SPPChildren', 'DISPID_SpeechGrammarRuleStateTransitions',
    'ISpeechPhraseAlternate', 'SPEI_PROPERTY_STRING_CHANGE',
    'SPXRO_SML', 'SVEPrivate', 'SpeechAudioFormatType',
    'SPEI_TTS_PRIVATE', 'ISpeechObjectTokenCategory',
    'SAFTNoAssignedFormat', 'SPVISEMES', 'DISPIDSPRG',
    'DISPID_SPIGrammarId', 'ISpAudio', 'SDTReplacement',
    'ISpeechPhraseReplacements', 'DISPID_SRDisplayUI',
    'DISPID_SRRPhraseInfo', 'DISPID_SLPLangId',
    'DISPID_SPEActualConfidence', 'SpeechPartOfSpeech', 'SP_VISEME_7',
    'DISPID_SPPs_NewEnum', 'SPSERIALIZEDPHRASE'
]

_check_version('1.1.13', 1610530748.801873)
